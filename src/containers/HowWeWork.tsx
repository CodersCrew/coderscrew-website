...
export const HowWeWork = () => (
  <div className="flex flex-col mx-auto items-center gap-34 py-24  lg:items-stretch lg:px-30 max-w-screen-2xl">
    <div className="grid items-end justify-center  lg:grid-cols-[50%_50%] gap-6 lg:gap-0">
