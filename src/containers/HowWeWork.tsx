...
export const HowWeWork = () => (
  <div className="mx-auto flex max-w-screen-2xl flex-col items-center gap-34  py-24 lg:items-stretch lg:px-30">
    <div className="grid items-end justify-center gap-6 lg:grid-cols-[50%_50%] lg:gap-0">
      <div className="flex flex-col items-start bg-additional-white lg:gap-8 lg:bg-additional-darkWhite">
        <h2 className="mb-4 mt-6 pl-8 text-[24px] lg:text-[32px] font-bold uppercase text-quaternary lg:pl-0">Jak działamy?</h2>
        <Card
          title="Online"
      ...
      <UndrawWorld className='px-7 xl:px-20' />
    </div>
